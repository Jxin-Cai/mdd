...
public class NodeDO {
     ...
     * @param order    节点创建顺序
     */
    public static NodeDO of(NodeDesc nodeDesc, Integer order){
        return new NodeDO(nodeDesc.getId(),
                        nodeDesc.getAddress(),
     ...
     * @return 节点对象
     */
    public static NodeDO of(String nodeId, Long idleMemSize, BigDecimal cpuUsageRatio){
        final NodeDO ret = new NodeDO();
